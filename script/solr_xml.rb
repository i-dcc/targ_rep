...
def create_schema_xml(all_attributes)
  replacement_text = []
...
#<uniqueKey>mgi_allele_id</uniqueKey>





  IO.write(File.dirname(__FILE__) + '/schema_new.xml', text)
end

################################################################################

create_schema_xml(es_cell_attributes + cdata_attributes)
