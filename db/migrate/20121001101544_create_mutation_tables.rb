class CreateMutationTables < ActiveRecord::Migration
  ...
  def self.up
    rename_column :alleles, :mutaion_method, :mut_method
    rename_column :alleles, :mutaion_type, :mut_type
    rename_column :alleles, :mutaion_subtype, :mut_subtype
...
#    remove_column :alleles, :mut_subtype
  ...
  def self.down
    ...
    remove_column :alleles,  :mutation_subtype_id, :integer
