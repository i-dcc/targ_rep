class AddExtraFieldsToEsCells < ActiveRecord::Migration
  def self.up
    ...
    add_column    :es_cells, :upper_LR_chk_passed, :boolean
    add_column    :es_cells, :upper_SR_chk_passed, :boolean
    add_column    :es_cells, :lower_LR_chk_passed, :boolean
    add_column    :es_cells, :lower_SR_chk_passed, :boolean
  end
